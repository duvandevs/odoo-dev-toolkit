...
class ModuleUpdaterController(http.Controller):
    ...
    @http.route('/quick_updater_rw/search_module', type='json', auth='user')
    ...
    @http.route('/quick_updater_rw/get_favorite_modules', type='json', auth='user')
    ...
    @http.route('/quick_updater_rw/update_module', type='json', auth='user')
    def update_module(self, module_id):
        ...
        try:
            ...
            Module = request.env['ir.module.module'].sudo()
            UpdateLog = request.env['quick.updater.rw.log'].sudo() if 'quick.updater.rw.log' in request.env else None
    ...
    @http.route('/quick_updater_rw/get_modules', type='json', auth='user')
